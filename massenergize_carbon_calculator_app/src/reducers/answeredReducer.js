    ...
    case QUESTION_ANSWERED:
      return {
        ...
        [action.payload.actionName]: {
          ...state[action.payload.actionName],
          [action.payload.questionTag]: action.payload.answer
        },
        skip: {
          ...state.skip,
          [action.payload.questionTag]: action.payload.skip
        }
      };
    case GET_SCORE:
      return {
